...
import { LogIn, Github } from "lucide-react";
import { GridPattern } from "@/components/ui/animated-grid-pattern";
import FeedbackWidgetDetail from "./WidgetDetail";
  ...
  return (
    <section className="grow relative overflow-hidden">
      <GridPattern
        ...
        repeatDelay={0.5}
      />
      <div className="container mx-auto px-4 mb-24 mt-0 flex flex-col md:flex-row justify-between items-center relative z-10">
        <div className="flex flex-col max-w-xl justify-center md:w-1/2">
          <div className="mb-8">
            <h1 className="mb-5 text-5xl font-extrabold leading-tight">
              Start collecting feedbacks in seconds
            </h1>
